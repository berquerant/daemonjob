...
var kustomizeRoot = filepath.Join(utils.Must(os.Getwd()), "kustomize")

// namespace where the project is deployed in
const namespace = "daemonjob-system"

// serviceAccountName created for the project
const serviceAccountName = "daemonjob-controller-manager"

// metricsServiceName is the name of the metrics service of the project
const metricsServiceName = "daemonjob-controller-manager-metrics-service"

// metricsRoleBindingName is the name of the RBAC that will be created to allow get the metrics data
const metricsRoleBindingName = "daemonjob-metrics-binding"
	...
	Context("Manager", func() {
		...
		It("should ensure the metrics endpoint is serving metrics", func() {
			...
			cmd := utils.KubectlCmd("create", "clusterrolebinding", metricsRoleBindingName,
				"--clusterrole=daemonjob-metrics-reader",
		...
		Context("Main", func() {
			suite := &utils.Suite{
				Name:            "Main",
				NamespacePrefix: "daemonjob-test",
				KustomizeRoot:   kustomizeRoot,
			}
			suite.Testcases = append(suite.Testcases, daemonJobTestcases()...)
