...
func generateDaemonJob(dj *daemonjobv1.DaemonJob, nodes []string, image, clusterRole string) *WriteResult {
	...
	return &WriteResult{
		Header:    fmt.Sprintf("Generated by daemonjobctl\nInput: DaemonJob/%s (namespace: %s)", dj.Name, dj.Namespace),
		Direct:    direct,
		Simulated: simulated,
	}
}
...
func generateDaemonCronJob(dcj *daemonjobv1.DaemonCronJob, nodes []string, image, clusterRole string) *WriteResult {
	...
	return &WriteResult{
		Header:    fmt.Sprintf("Generated by daemonjobctl\nInput: DaemonCronJob/%s (namespace: %s)", dcj.Name, dcj.Namespace),
		Direct:    direct,
		Simulated: simulated,
	}
}
...
func generateDaemonCronJobSet(dcjs *daemonjobv1.DaemonCronJobSet, nodes []string) *WriteResult {
	...
	return &WriteResult{
		Header: fmt.Sprintf("Generated by daemonjobctl\nInput: DaemonCronJobSet/%s (namespace: %s)", dcjs.Name, dcjs.Namespace),
		Direct: direct,
	}
}
